...
const AdminStudentSearch = () => {
  ...
  const handleEditClick = (studentId: number) => {
    ...
    if (confirmEdit) {
      // Redirigir a la página de edición del alumno
                ...
                if (displayedStudents.length === index + 1) {
                  return (
                    <div
                      ...
                      key={student.id}
                      className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer flex justify-between items-center"
                    >
                      ...
                      <button
                        ...
                        className="bg-custom-accent text-white px-4 py-2 rounded-lg hover:bg-custom-accent-dark transition-colors"
                      >
                        Editar
                      </button>
                    </div>
